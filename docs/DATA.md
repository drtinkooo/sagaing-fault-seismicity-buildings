...
| `minlongitude` | 92 | Western boundary |
| `maxlongitude` | 101.2 | Eastern boundary |
| `minmagnitude` | 2.5 | Minimum magnitude threshold |
| `orderby` | time | Sort by occurrence time |
| `format` | geojson | Output format |

### API Query URL

```
https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2025-03-28&endtime=2025-12-10&minlatitude=9.5&maxlatitude=28.5&minlongitude=92&maxlongitude=101.2&minmagnitude=2.5&orderby=time
```
...
curl -o earthquakes.geojson "https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2025-03-28&endtime=$(date +%Y-%m-%d)&minlatitude=9.5&maxlatitude=28.5&minlongitude=92&maxlongitude=101.2&minmagnitude=2.5&orderby=time"
...
url = f'https://earthquake.usgs.gov/fdsnws/event/1/query?format=geojson&starttime=2025-03-28&endtime={datetime.now().strftime(\"%Y-%m-%d\")}&minlatitude=9.5&maxlatitude=28.5&minlongitude=92&maxlongitude=101.2&minmagnitude=2.5&orderby=time'
